        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad aborda la importancia de la comunicación escrita en el ámbito académico y profesional, destacando la coherencia, cohesión y claridad en la redacción. Se exploran normas ortográficas, construcción de textos argumentativos y expositivos, uso adecuado de conectores lógicos y estructuración de párrafos. Además, se analizan las Normas APA para la citación y referencia de fuentes. También se presentan los géneros discursivos clave, como artículos de opinión, informes y relatorías. A través de ejercicios prácticos, se busca fortalecer la escritura efectiva y fundamentada, esencial para la producción de textos académicos de calidad.
